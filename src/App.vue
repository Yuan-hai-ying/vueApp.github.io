...
.mui-bar-tab .mui-tab-item-yhy.mui-active{
	color:red;
}
...
.mui-bar-tab .mui-tab-item-yhy .mui-icon {
    top: 3px;
    width: 24px;
    height: 24px;
    padding-top: 0;
...
.mui-bar-tab .mui-tab-item-yhy .mui-icon~.mui-tab-label {
    font-size: 11px;
    display: block;
    overflow: hidden;
    text-overflow: ellipsis;
